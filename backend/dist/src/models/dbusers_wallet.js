...
exports.dbusers_wallet = void 0;
const db_1 = require("./db");
const moment_1 = __importDefault(require("moment/moment"));
class dbusers_wallet extends db_1.db {
    constructor() {
        super();
        this.table = "users_wallet";
    }
    listUsersWallets(user_id) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let result = yield this.listRecords();
            return_data = {
                error: false,
                message: "Success",
                data: result
...
exports.dbusers_wallet = dbusers_wallet;
